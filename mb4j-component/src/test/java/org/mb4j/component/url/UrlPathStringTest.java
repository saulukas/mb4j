...
public class UrlPathStringTest {
  @Test
  public void urlPathOf_splits_into_segments_at_slashes() {
  ...
  @Test
  public void urlPathOf_ignores_leading_and_trailing_slashes() {
    assertThat(urlPathOf("///a///").segments(), contains("a"));
    assertThat(urlPathOf("///a/b//").segments(), contains("a", "b"));
    assertThat(urlPathOf("////a/b/c/").segments(), contains("a", "b", "c"));
  }
  ...
  @Test
  public void urlPathOf_omits_empty_segments() {
    assertThat(urlPathOf("a//b").segments(), contains("a", "b"));
    assertThat(urlPathOf("a///b").segments(), contains("a", "b"));
    assertThat(urlPathOf("a//b//c").segments(), contains("a", "b", "c"));
  }
  ...
  @Test
  public void urlPathOf_null_string_or_empty_string_becomes_empty_path() {
